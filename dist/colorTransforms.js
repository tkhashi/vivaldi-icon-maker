export function createInactiveColor(color, mixRatio) {
...
export function createInactiveBackgroundColor(color, mixRatio) {
    const ratio = clamp(mixRatio, 0, 1);
    const parsed = parseHexColor(color);
...
function hasExplicitAlpha(input) {
